          ...
          <div className="flex items-center gap-5">
            ...
            >
              <svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  <radialGradient id="gh-top" cx="38%" cy="28%" r="62%">
                    <stop offset="0%" stopColor="#4a4a4a"/>
                    <stop offset="100%" stopColor="#111111"/>
                  </radialGradient>
                  <radialGradient id="gh-shine" cx="35%" cy="25%" r="45%">
            ...
            >
              <svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  <radialGradient id="li-top" cx="35%" cy="25%" r="65%">
                    <stop offset="0%" stopColor="#2a9fd6"/>
                    <stop offset="100%" stopColor="#0a66c2"/>
                  </radialGradient>
                  <radialGradient id="li-shine" cx="32%" cy="22%" r="44%">
                ...
                <path d="M13 15.5h-2.5V27H13V15.5zM11.75 14.5a1.5 1.5 0 100-3 1.5 1.5 0 000 3zM27 27h-2.5v-5.5c0-1.38-.56-2-1.63-2-1.14 0-1.87.75-1.87 2V27H18.5V15.5H21v1.2c.54-.83 1.5-1.45 2.75-1.45C26.1 15.25 27 16.7 27 19.5V27z"
            ...
            >
              <svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  <radialGradient id="tw-top" cx="35%" cy="25%" r="65%">
                    <stop offset="0%" stopColor="#3a3a3a"/>
                    <stop offset="100%" stopColor="#000000"/>
                  </radialGradient>
                  <radialGradient id="tw-shine" cx="32%" cy="22%" r="44%">
                ...
                <path d="M21.5 12h2.8l-6.1 7 7.2 9.5H21l-4.4-5.8-5 5.8H8.8l6.5-7.5L8.5 12h5.5l4 5.3L21.5 12zm-1 14.8h1.5L14 13.4h-1.6l8.1 13.4z"
                  fill="white" opacity="0.95"/>
              </svg>
            </a>
          </div>
...
function ChatWidget() {
  ...
  const send = async (text) => {
    ...
    try {
      ...
      const reply = data?.content?.[0]?.text || "Sorry, I couldn't get a response right now. Please reach out directly at devduality7@gmail.com";
      setMessages([...newMessages, { role: "assistant", content: reply }]);
    } catch {
      setMessages([...newMessages, { role: "assistant", content: "Something went wrong on my end. Please email us at devduality7@gmail.com or call directly!" }]);
    } finally {
      setLoading(false);
    }
  };
